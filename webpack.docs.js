...
export default {
  ...
  module: {
    ...
    loaders: [
      ...
      /* eslint-disable */
      { test: /\.woff(\?\S*)?$/, loader: "url-loader?name=fonts/[name].[ext]&limit=10000&mimetype=application/font-woff" },
      { test: /\.woff2(\?\S*)?$/, loader: "url-loader?name=fonts/[name].[ext]&limit=10000&mimetype=application/font-woff2" },
      { test: /\.ttf(\?\S*)?$/, loader: "url-loader?name=fonts/[name].[ext]&limit=10000&mimetype=application/font-ttf" },
      { test: /\.eot(\?\S*)?$/, loader: "file-loader?name=fonts/[name].[ext]&limit=10000&mimetype=application/vnd.ms-fontobject" },
      { test: /\.svg(\?\S*)?$/, loader: "url-loader?name=fonts/[name].[ext]&limit=10000&mimetype=image/svg+xml" }
      /* eslint-enable */
    ]
  },
